...
DECLARE_MULTICAST_DELEGATE_OneParam(FCSOnCreateSessionComplete, bool Successful);
DECLARE_MULTICAST_DELEGATE_OneParam(FCSOnUpdateSessionComplete, bool Successful);
DECLARE_MULTICAST_DELEGATE_OneParam(FCSOnStartSessionComplete, bool Successful);
DECLARE_MULTICAST_DELEGATE_OneParam(FCSOnEndSessionComplete, bool Successful);
DECLARE_MULTICAST_DELEGATE_OneParam(FCSOnDestroySessionComplete, bool Successful);
